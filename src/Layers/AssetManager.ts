...
import particlesFragSource from "../Shaders/PARTICLES.frag?raw";
import particlesVertSource from "../Shaders/PARTICLES.vert?raw";
...
export default class AssetManager 
{
    ...
    public static LoadAllAssets() 
    {
        ...
        var PARTICLES_SHADER = Shader.Create(particlesVertSource, particlesFragSource, "PARTICLES_SHADER");
        ...
        var PARTICLES_MAT = new PhysicalMaterial(PARTICLES_SHADER);
        ...
        AssetManager.materials.set(AssetRegistry.MAT_PARTICLES, PARTICLES_MAT);
